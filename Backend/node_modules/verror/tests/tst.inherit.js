...
// Test.js that `<Ctor>.toString()` uses the ctor name. I.e. setting
...
// Test.js that `<Ctor>.prototype.name` can be used for the `.toString()`
...
// Test.js get appropriate exception name in `.toString()` when reconstituting
